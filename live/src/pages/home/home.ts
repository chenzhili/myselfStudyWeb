...
export class HomePage {
  ...
  ionViewDidEnter() {
    ...
    for(let i=0;i<dateList.length;i++){
      ...
      console.log(dateList[i].offsetTop);
    }
    let contentTop= document.getElementsByClassName("adv_banner")[0].getBoundingClientRect().top;
    let dateTop = document.getElementsByClassName("date")[0].getBoundingClientRect().top;
